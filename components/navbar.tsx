    ...
    <div className="flex items-center min-w-full w-full fixed justify-center p-2 z-[50] mt-[2rem]">
      <div className="flex justify-between md:w-[720px] w-[95%] border dark:border-zinc-900 dark:bg-black bg-opacity-10 relative backdrop-filter backdrop-blur-lg bg-white border-white border-opacity-20 rounded-xl p-2 shadow-lg">
        <Dialog>
          ...
          <SheetContent side="left">
            ...
            <div className="flex flex-col space-y-3 mt-[1rem] z-[99]">
              ...
              <DialogClose asChild>
                <Link href="/software">
                  <Button variant="outline" className="w-full">How to Use</Button>
                </Link>
              </DialogClose>
              <DialogClose asChild>
              ...
              <DialogClose asChild>
                <Link href="/blog">
                  <Button variant="outline" className="w-full">Blogs</Button>
                </Link>
              </DialogClose>
              <DialogClose asChild>
                <Link href="/auth">
        ...
        <NavigationMenu>
          <NavigationMenuList className="max-[825px]:hidden ">
            <Link href="/" className="pl-2">
              <h1 className="font-bold">𝙲𝚞𝚝𝚎𝙰𝙸</h1>
            </Link>
          </NavigationMenuList>
        </NavigationMenu>
        <div className="flex items-center gap-2 max-[825px]:hidden">
          ...
          <Link href="#">
            <Button variant="ghost">Go Pro</Button>
          </Link>
          <Link href="#">
